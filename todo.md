...
- [ ] Gerar ZIP atualizado com frontend, backend, banco, migrações e configurações de deploy
- [ ] Validar ausência de segredos, dependências e artefatos reconstruíveis no ZIP
- [ ] Entregar o arquivo ZIP atualizado para download manual
